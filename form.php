...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO contactu2 (name, email, concern, date) VALUES ('$name', '$email', '$concern', CURRENT_TIMESTAMP)";
        ...
        if ($result) {
            ...
            <strong>Error!</strong> We are facing some technical issue and Your entry has not been submitted successfully!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>';
